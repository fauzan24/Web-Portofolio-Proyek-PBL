    ...
    <div class="form-card">
        ...
        <form action="proses_tambah_dosen.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama" class="form-control" required placeholder="Masukkan nama dosen">
            </div>

            <div class="mb-3">
                <label class="form-label">Username</label>
                <input type="text" name="username" class="form-control" required placeholder="Masukkan username login">
            </div>

            <div class="mb-3">
                <label class="form-label">NIP</label>
                <input type="text" name="nim" class="form-control" placeholder="Masukkan NIP">
            </div>
