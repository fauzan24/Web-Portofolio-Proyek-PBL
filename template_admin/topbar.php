...
<div class="offcanvas offcanvas-start" id="mobileSidebar">
  ...
  <div class="offcanvas-body">
    <a class="nav-link mb-2" href="../admin/dashboard_admin.php">
      <i class="fa-solid fa-house me-2"></i> Beranda
    </a>
    <a class="nav-link mb-2" href="../admin/kelola_mahasiswa.php">
      <i class="fa-solid fa-users me-2"></i> Kelola Mahasiswa
    </a>
    <a class="nav-link mb-2" href="../admin/kelola_dosen.php">
      <i class="fa-solid fa-user-tie me-2"></i> Kelola Dosen
    </a>
  </div>
</div>
